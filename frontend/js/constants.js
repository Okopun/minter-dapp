...
const welcome_h1 = "Welcome to the Polygon Trees NFT project!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Polygon Trees is a collection of 1000 saplings growing on the polygon network. Each NFT represents a physical tree I plant in real life.';
const h1_presale_coming_soon = "NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const p_public_mint = "Public Minting Open!!";
